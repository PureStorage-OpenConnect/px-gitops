...
sleep 5
vBACKUPNAME="$(kubectl get VolumeSnapshot -n springboot-code-main -l=name=snapshot-of-wordpress-app --sort-by=.metadata.creationTimestamp -o jsonpath='{.items[-1:].metadata.name}')"
echo $vBACKUPNAME;