...
argo --kubeconfig=$ClusterKubeConfigFilePath cluster-template create ../argo-worflow/wordpress-app/workflow-templates/clusterworkflowtemplate-for-master.yaml
argo --kubeconfig=$ClusterKubeConfigFilePath cluster-template create ../argo-worflow/wordpress-app/workflow-templates/clusterworkflowtemplate-for-dev.yaml
rm config
